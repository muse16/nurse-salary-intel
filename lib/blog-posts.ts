...
const allBlogPosts: BlogPost[] = [
  // ── Week-14 ────────────────────────────────────────────────────────────────
  {
    slug: 'hca-rn-salary-2026',
    title: 'HCA RN Salary 2026: What the Largest Hospital System Pays Nurses',
    metaTitle: 'HCA RN Salary 2026: Full Pay Breakdown',
    date: '2026-05-27',
    excerpt: 'HCA Healthcare RNs earn $32–$50/hr base ($66K–$104K/yr). See shift differential, sign-on bonuses up to $25K, and how HCA compares to Ascension, Tenet, and Kaiser.',
    category: 'Salary Data',
    readTime: '9 min',
    focusKeyword: 'hca rn salary 2026',
    secondaryKeywords: ['hca nurse salary', 'hca healthcare nurse pay', 'hca night shift differential', 'hca sign on bonus nurses', 'hca vs ascension nurse pay'],
    coverImage: '/images/hca-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse reviewing documentation at a hospital nursing station, HCA hospital setting, professional, no logos',
    metaDescription: 'HCA nurses earn $66,000–$104,000/year. See base pay, $4–$7/hr night differential, sign-on bonuses to $25K, and how HCA compares to Ascension, Tenet, and Kaiser.',
    href: '/hca-rn-salary-2026',
    content: '',
  },
  {
    slug: 'michigan-rn-salary-2026',
    title: 'Michigan RN Salary 2026: Union vs. Non-Union Pay Compared',
    metaTitle: 'Michigan RN Salary 2026: Union vs. Non-Union',
    date: '2026-05-27',
    excerpt: 'Michigan RNs earn $78,280/year on average — but Detroit union nurses at Michigan Medicine earn $88,000–$96,000. See MI nurse pay by city, hospital, and union status.',
    category: 'Salary Data',
    readTime: '8 min',
    focusKeyword: 'michigan rn salary 2026',
    secondaryKeywords: ['michigan nurse salary', 'how much do nurses make in michigan', 'detroit rn salary', 'michigan nurses association', 'michigan nurse union pay'],
    coverImage: '/images/michigan-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse outside a Michigan hospital, professional posture, Great Lakes sky, no text, no logos',
    metaDescription: 'Michigan RNs average $78,280/year — but union nurses at Michigan Medicine earn $88K–$96K. See MI salary by metro, hospital system, and union vs. non-union.',
    href: '/michigan-rn-salary-2026',
    content: '',
  },
  {
    slug: 'new-jersey-rn-salary-2026',
    title: 'New Jersey RN Salary 2026: $99,280/yr — What NJ Nurses Earn',
    metaTitle: 'New Jersey RN Salary 2026: $99,280/yr',
    date: '2026-05-27',
    excerpt: 'New Jersey RNs earn $99,280/year — the third-highest in the country. See NJ nurse salary by city, hospital, specialty, and how HPAE union contracts affect pay.',
    category: 'Salary Data',
    readTime: '8 min',
    focusKeyword: 'new jersey rn salary 2026',
    secondaryKeywords: ['nurse salary nj', 'nj rn salary', 'new jersey nurse salary', 'newark nurse salary', 'hackensack meridian nurse pay', 'hpae union nurses'],
    coverImage: '/images/new-jersey-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in navy scrubs standing outside a New Jersey hospital, urban skyline background, golden hour light, no logos',
    metaDescription: 'New Jersey RNs earn $99,280/year — third-highest in the US. See NJ nurse pay by metro area, hospital, specialty, and HPAE union contract impact.',
    href: '/new-jersey-rn-salary-2026',
    content: '',
  },
  {
    slug: 'hospice-nurse-salary-2026',
    title: 'Hospice Nurse Salary 2026: What Hospice RNs Really Earn',
    metaTitle: 'Hospice Nurse Salary 2026',
    date: '2026-05-27',
    excerpt: 'Hospice nurses earn $79,050–$91,640/year depending on setting. See pay by role, state, and employer — plus how hospice compares to hospital RN pay.',
    category: 'Salary Data',
    readTime: '7 min',
    focusKeyword: 'hospice nurse salary 2026',
    secondaryKeywords: ['hospice rn salary', 'hospice nurse pay', 'palliative care nurse salary', 'home health rn salary', 'hospice nursing salary by state'],
    coverImage: '/images/hospice-nurse-salary-2026-hero.webp',
    imageAlt: 'Hospice nurse sitting compassionately beside a patient in a warm home setting, natural window light, no text, no logos',
    metaDescription: 'Hospice nurses earn $79,050–$91,640/year depending on work setting. See hospice RN pay by state, role, and how it compares to hospital nursing.',
    href: '/hospice-nurse-salary-2026',
    content: '',
  },
  {
    slug: 'lvn-salary-2026',
    title: 'LVN Salary 2026: What Licensed Vocational Nurses Earn',
    metaTitle: 'LVN Salary 2026: Full State-by-State Guide',
    date: '2026-05-27',
    excerpt: 'LVNs earn $61,790/year nationally. California pays $70,940; Texas $56,020. See LVN salary by state, work setting, and how the LVN-to-RN bridge changes the math.',
    category: 'Salary Data',
    readTime: '7 min',
    focusKeyword: 'lvn salary 2026',
    secondaryKeywords: ['licensed vocational nurse salary', 'lvn pay', 'lvn salary california', 'lvn salary texas', 'lpn vs lvn salary', 'lvn to rn salary increase'],
    coverImage: '/images/lvn-salary-2026-hero.webp',
    imageAlt: 'Licensed vocational nurse in navy scrubs reviewing a patient chart in a bright clinic hallway, professional, no logos',
    metaDescription: 'LVNs earn $61,790/year nationally in 2026. California pays $70,940; Texas $56,020. See LVN salary by state, setting, and what the LVN-to-RN bridge adds.',
    href: '/lvn-salary-2026',
    content: '',
  },
  // ── Week-13 ────────────────────────────────────────────────────────────────
  {
    slug: 'certified-nurse-midwife-salary-2026',
    title: 'Certified Nurse Midwife Salary 2026: What CNMs Really Earn',
    metaTitle: 'Certified Nurse Midwife Salary 2026',
    date: '2026-05-26',
    excerpt: 'CNMs earn $120,880/year on average in 2026. See certified nurse midwife salary by state, setting, and how CNM pay compares to L&D RNs and OB/GYN NPs.',
    category: 'Specialty Salaries',
    readTime: '8 min',
    focusKeyword: 'certified nurse midwife salary 2026',
    secondaryKeywords: ['cnm salary', 'nurse midwife salary', 'midwife salary 2026', 'nurse midwife pay', 'cnm pay by state', 'how much do nurse midwives make'],
    coverImage: '/images/certified-nurse-midwife-salary-2026-hero.webp',
    imageAlt: 'Certified nurse midwife in scrubs consulting with a pregnant patient in a warm clinical setting',
    metaDescription: 'Certified nurse midwives earn $120,880/year on average in 2026. See CNM salary by state, work setting, and how it compares to L&D RNs and OB/GYN NPs.',
    href: '/certified-nurse-midwife-salary-2026',
    content: '',
  },
  {
    slug: 'aesthetic-nurse-salary-2026',
    title: 'Aesthetic Nurse Salary 2026: What Injectors & Med Spa RNs Earn',
    metaTitle: 'Aesthetic Nurse Salary 2026',
    date: '2026-05-26',
    excerpt: 'Aesthetic nurses earn $65,000–$110,000+ in 2026. See pay by role, setting, and commission structure — plus what it actually takes to break into medical aesthetics.',
    category: 'Specialty Salaries',
    readTime: '8 min',
    focusKeyword: 'aesthetic nurse salary 2026',
    secondaryKeywords: ['aesthetic rn salary', 'nurse injector salary', 'cosmetic nurse salary', 'med spa nurse salary', 'aesthetic nurse practitioner salary', 'how much do aesthetic nurses make'],
    coverImage: '/images/aesthetic-nurse-salary-2026-hero.webp',
    imageAlt: 'Aesthetic nurse practitioner in a modern medical spa consultation room with clean white interior and natural light',
    metaDescription: 'Aesthetic nurses earn $65,000–$110,000+ in 2026. See pay by role, setting, and commission structure — plus what it takes to break into medical aesthetics.',
    href: '/aesthetic-nurse-salary-2026',
    content: '',
  },
  {
    slug: 'dnp-salary-2026',
    title: 'DNP Salary 2026: Doctor of Nursing Practice Pay by Specialty',
    metaTitle: 'DNP Salary 2026: What DNP Nurses Earn',
    date: '2026-05-26',
    excerpt: 'DNP-prepared nurses earn $118,000–$214,000/year in 2026. See DNP salary by specialty, the premium over MSN, and whether the doctoral degree pays for itself.',
    category: 'Specialty Salaries',
    readTime: '9 min',
    focusKeyword: 'dnp salary 2026',
    secondaryKeywords: ['doctor of nursing practice salary', 'dnp nurse salary', 'dnp vs msn salary', 'dnp nursing salary', 'dnp degree salary', 'how much do dnp nurses make'],
    coverImage: '/images/dnp-salary-2026-hero.webp',
    imageAlt: 'Doctor of nursing practice in white coat reviewing clinical notes at a hospital workstation',
    metaDescription: 'DNP-prepared nurses earn $118,000–$214,000/year in 2026 depending on specialty. See DNP salary by role and whether the doctorate pays off vs MSN.',
    href: '/dnp-salary-2026',
    content: '',
  },
  {
    slug: 'whnp-salary-2026',
    title: "Women's Health NP Salary 2026: WHNP Pay by State & Setting",
    metaTitle: "Women's Health NP Salary 2026",
    date: '2026-05-26',
    excerpt: "Women's health NPs earn $122,000/year on average in 2026. See WHNP salary by state and setting — including fertility clinics, OB/GYN practices, and hospitals.",
    category: 'Specialty Salaries',
    readTime: '8 min',
    focusKeyword: "women's health nurse practitioner salary 2026",
    secondaryKeywords: ['whnp salary', 'whnp bc salary', "women's health np salary", 'ob gyn np salary', 'whnp vs cnm salary', 'how much do whnp make'],
    coverImage: '/images/whnp-salary-2026-hero.webp',
    imageAlt: "Women's health nurse practitioner consulting with a patient in a modern gynecology clinic",
    metaDescription: "Women's health NPs (WHNPs) earn $122,000/year on average in 2026. See salary by state, fertility clinic vs hospital pay, and WHNP vs CNM comparison.",
    href: '/whnp-salary-2026',
    content: '',
  },
  {
    slug: 'flight-nurse-salary-2026',
    title: 'Flight Nurse Salary 2026: What Air Medical RNs Really Earn',
    metaTitle: 'Flight Nurse Salary 2026',
    date: '2026-05-26',
    excerpt: 'Flight nurses earn $82,000–$110,000/year total in 2026. See base pay, flight differentials, hazard pay, and what it takes to get hired as an air medical nurse.',
    category: 'Specialty Salaries',
    readTime: '8 min',
    focusKeyword: 'flight nurse salary 2026',
    secondaryKeywords: ['flight rn salary', 'air medical nurse salary', 'flight nurse pay', 'cfrn salary', 'how much do flight nurses make', 'flight nurse vs icu nurse salary'],
    coverImage: '/images/flight-nurse-salary-2026-hero.webp',
    imageAlt: 'Flight nurse in full flight suit standing beside a medical helicopter on a hospital helipad at golden hour',
    metaDescription: 'Flight nurses earn $82,000–$110,000/year in total compensation in 2026. See pay by program type, full comp breakdown, and what it takes to get hired.',
    href: '/flight-nurse-salary-2026',
    content: '',
  },
  // ── Week-11 ────────────────────────────────────────────────────────────────
  {
    slug: 'psychiatric-nurse-salary-2026',
    title: 'Psychiatric Nurse Salary 2026: What Psych RNs Really Earn',
    metaTitle: 'Psychiatric Nurse Salary 2026',
    date: '2026-05-19',
    excerpt: 'Psychiatric RNs earn $81,000–$89,000/year nationally in 2026. See psych nurse pay by state, setting, and certification — inpatient vs. outpatient compared.',
    category: 'Specialty Salaries',
    readTime: '8 min',
    focusKeyword: 'psychiatric nurse salary 2026',
    secondaryKeywords: ['psych nurse salary', 'psychiatric rn salary', 'mental health nurse salary 2026', 'pmh-bc certification pay', 'inpatient psych nurse salary', 'how much do psychiatric nurses make'],
    coverImage: '/images/psychiatric-nurse-salary-2026-hero.webp',
  ...
  },
  {
    ...
    metaTitle: 'Tampa RN Salary 2026',
    date: '2026-05-19',
    excerpt: 'Tampa RNs earn $73,000/year on average in 2026. See salary by hospital, specialty, and experience — with Florida no-income-tax take-home analysis.',
    category: 'Salary Data',
    readTime: '8 min',
    focusKeyword: 'tampa rn salary 2026',
    secondaryKeywords: ['nurse salary tampa fl', 'tampa general hospital rn salary', 'florida nurse salary 2026', 'moffitt cancer center nurse pay', 'tampa vs orlando nurse salary', 'how much do nurses make in tampa'],
    coverImage: '/images/tampa-rn-salary-2026-hero.webp',
  ...
  },
  {
    ...
    metaTitle: 'Oncology Nurse Salary 2026',
    date: '2026-05-19',
    excerpt: 'Oncology RNs earn $82,000–$92,000/year in 2026. See onc nurse pay by setting, state, and certification — NCI cancer centers vs. community hospitals compared.',
    category: 'Specialty Salaries',
    readTime: '9 min',
    focusKeyword: 'oncology nurse salary 2026',
    secondaryKeywords: ['oncology rn salary', 'cancer nurse pay 2026', 'ocn certification salary', 'nci cancer center nurse salary', 'bmtcn salary', 'how much do oncology nurses make'],
    coverImage: '/images/oncology-nurse-salary-2026-hero.webp',
  ...
  },
  {
    ...
    metaTitle: 'Detroit RN Salary 2026',
    date: '2026-05-19',
    excerpt: 'Detroit RNs earn $82,000/year on average in 2026. Henry Ford Health pays $80K–$102K. See salary by hospital, specialty, and experience — with Michigan tax take-home breakdown.',
    category: 'Salary Data',
    readTime: '8 min',
    focusKeyword: 'detroit rn salary 2026',
    secondaryKeywords: ['nurse salary detroit michigan', 'henry ford hospital rn salary', 'michigan rn salary 2026', 'detroit medical center nurse pay', 'detroit vs chicago nurse salary', 'how much do nurses make in detroit'],
    coverImage: '/images/detroit-rn-salary-2026-hero.webp',
  ...
  },
  {
    ...
    metaTitle: 'BSN Nurse Salary & Career Paths',
    date: '2026-05-19',
    excerpt: 'BSN nurses have more high-paying options than most realize. See 8 career paths over $85K in 2026 — from ICU and CRNA to travel nursing, informatics, and NP — with real salary ranges.',
    category: 'Salary Data',
    readTime: '10 min',
    focusKeyword: 'bsn nurse salary 2026',
    secondaryKeywords: ['bsn career paths salary', 'what can bsn nurse do to make more money', 'bsn vs adn salary difference', 'highest paying jobs for bsn nurses', 'how to increase nurse salary with bsn', 'bsn nurse career options'],
    coverImage: '/images/bsn-nurse-salary-career-paths-2026-hero.webp',
  ...
  // ── Week-09 ────────────────────────────────────────────────────────────────
  {
    ...
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'nurse shift differential pay 2026',
    secondaryKeywords: ['night shift differential nursing', 'how much does night shift add to nurse salary', 'weekend differential nurse pay', 'RN shift differential by hospital', 'how to negotiate shift differential'],
    coverImage: '/images/shift-differential-nurse-pay-2026-hero_compressed.webp',
    imageAlt: 'Registered nurse working a night shift at a hospital nursing station with dimmed lighting',
    metaDescription: 'Night shift differential adds $4–$12/hr to RN pay — $7,200–$21,600/year for full-time night nurses. Rates by system, stacking scenarios, and negotiation tips.',
  ...
  },
  {
    ...
    readTime: '7 min read',
    focusKeyword: 'how to negotiate nurse salary with data',
    secondaryKeywords: ['nurse salary research negotiation', 'using BLS data to negotiate salary', 'nurse salary negotiation tips 2026', 'RN salary benchmarks negotiation', 'nurse offer negotiation data'],
    coverImage: '/images/nurse-salary-negotiation-data-guide-2026-hero_compressed.webp',
    imageAlt: 'Nurse in scrubs reviewing salary data documents across a desk from a hospital HR manager',
    metaDescription: "Most nurses negotiate blind. Here's how to pull BLS OEWS data, job posting ranges, and cost-of-living benchmarks before your next offer conversation.",
    href: '/nurse-salary-negotiation-data-guide-2026',
    content: '',
  },
  {
    ...
    category: 'Salary Data',
    readTime: '6 min read',
    focusKeyword: 'Cleveland RN salary 2026',
    secondaryKeywords: ['nurse salary Cleveland OH', 'Cleveland Clinic nurse pay', 'Ohio nurse salary 2026', 'Cleveland hospital RN pay', 'Cleveland nurse cost of living'],
    coverImage: '/images/cleveland-rn-salary-2026-hero_compressed.webp',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern Cleveland Ohio hospital near Lake Erie',
    metaDescription: 'Cleveland RNs earn $74,000/yr ($35.58/hr) in 2026. Cleveland Clinic pays $78K–$98K. See salary by hospital, specialty, and purchasing-power comparison vs. major US cities.',
    href: '/cleveland-rn-salary-2026',
    content: '',
  },
  {
    ...
    category: 'Salary Data',
    readTime: '6 min read',
    focusKeyword: 'Portland RN salary 2026',
    secondaryKeywords: ['nurse salary Portland OR', 'OHSU nurse pay', 'Oregon nurse salary 2026', 'Portland hospital RN pay', 'Oregon income tax nurse salary'],
    coverImage: '/images/portland-rn-salary-2026-hero_compressed.webp',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern Portland Oregon hospital with the Willamette River in the background',
    metaDescription: "Portland RNs earn $109,000/yr ($52.40/hr) in 2026. OHSU pays $102K–$125K. See salary by hospital, specialty, and Oregon's income tax impact on take-home pay.",
    href: '/portland-rn-salary-2026',
    content: '',
  },
  {
    ...
    category: 'Salary Data',
    readTime: '6 min read',
    focusKeyword: 'Baltimore RN salary 2026',
    secondaryKeywords: ['nurse salary Baltimore MD', 'Johns Hopkins nurse pay', 'Maryland nurse salary 2026', 'Baltimore hospital RN pay', 'UMMC Shock Trauma nurse salary'],
    coverImage: '/images/baltimore-rn-salary-2026-hero_compressed.webp',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern Baltimore Maryland hospital with the Inner Harbor in the background',
    metaDescription: 'Baltimore RNs earn $89,000/yr ($42.79/hr) in 2026. Johns Hopkins pays $88K–$110K. See salary by hospital, specialty, and Maryland tax breakdown.',
    href: '/baltimore-rn-salary-2026',
    content: '',
  },
  // ── Week-08 and earlier ────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    category: 'Salary Data',
    readTime: '6 min read',
    focusKeyword: 'Houston RN salary 2026',
    secondaryKeywords: ['nurse salary Houston TX', 'Houston Methodist nurse pay', 'Texas nurse salary 2026', 'Houston hospital RN pay', 'Texas no income tax nurse'],
    coverImage: '/images/houston-rn-salary-2026-hero.png',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern Houston Texas hospital',
    metaDescription: 'Houston RNs earn $83,500/yr ($40.14/hr) in 2026. Texas has no state income tax. See pay by hospital, specialty, and experience — with take-home pay analysis.',
  ...
  },
  {
    ...
    category: 'Salary Data',
    readTime: '6 min read',
    focusKeyword: 'Seattle RN salary 2026',
    secondaryKeywords: ['nurse salary Seattle WA', 'UW Medical Center nurse pay', 'Washington state nurse salary 2026', 'Seattle hospital RN pay', 'highest paying cities for nurses'],
    coverImage: '/images/seattle-rn-salary-2026-hero.png',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern Seattle Washington hospital',
    metaDescription: "Seattle RNs earn $110,000/yr ($52.88/hr) in 2026 — among America's highest. Washington has no state income tax. See pay by hospital, specialty, and experience.",
  ...
  },
  {
    ...
    category: 'Salary Data',
    readTime: '6 min read',
    focusKeyword: 'Atlanta RN salary 2026',
    secondaryKeywords: ['nurse salary Atlanta GA', 'Emory Healthcare nurse pay', 'Georgia nurse salary 2026', 'Atlanta hospital RN pay', 'Grady Memorial nurse salary'],
    coverImage: '/images/atlanta-rn-salary-2026-hero.png',
    imageAlt: 'Registered nurse in scrubs standing outside a modern Atlanta Georgia hospital',
    metaDescription: 'Atlanta RNs earn $79,000/yr ($37.98/hr) in 2026. See pay at Emory Healthcare, Grady Memorial, Northside, and Wellstar — with Georgia tax and PSLF analysis.',
...
<p>You can get the exact scripts for this and 14 other contract red flags in the <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> — including email templates that have gotten nurses real changes to their offers.</p>
...
<p>For the exact word-for-word email scripts covering 15 contract negotiation scenarios — including sign-on bonus counters, non-compete pushback, and PTO clawback negotiation — see the <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a>.</p>
...
<p>If you find red flags, the <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> gives you the exact email language to push back on each one.</p>
    `,
  },
  {
...
<p>Before signing any ICU travel contract, run it through our <a href="/audit" style="color:#2563eb;font-weight:600;">free Contract Red Flag Audit</a>. If you find issues, the <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> gives you the exact language to push back.</p>
    `,
  },
  {
...
<p>A high-pay state means nothing if the contract has hidden cancellation clauses or missing overtime guarantees. Run your offer through the <a href="/audit" style="color:#2563eb;font-weight:600;">free Contract Red Flag Audit</a> before you sign — it takes 3 minutes and flags the 10 most common issues that cost nurses money. For the full set of negotiation scripts and counter-offer language, the <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> is reusable on every future contract.</p>
...
<p>This guide breaks down exactly what to negotiate, how to ask, and the scripts to use over the phone and in email. It's the same framework used in our <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a>.</p>
...
<p>The <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> includes word-for-word counter-offer emails, recruiter phone scripts, and legal addendum language — reusable on every contract you'll ever sign.</p>
...
<ul>
  ...
  },
  {
    ...
    metaTitle: '5 Contract Clauses That Cost Nurses Thousands',
    date: '2026-04-15',
...
<p>The <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> includes word-for-word email templates and addendum language for every clause covered here, plus 5 more.</p>

<h2>Before You Sign</h2>
<p>These five clauses are responsible for most of the avoidable financial damage nurses take each year. Run your offer through the <a href="/audit" style="color:#2563eb;font-weight:600;">free Contract Red Flag Audit</a> to screen for the 10 most common issues, then use the negotiation scripts in the <a href="/contract-audit" style="color:#2563eb;font-weight:600;">Free Contract Audit Kit</a> to push back.</p>
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'Highest Paying States for Nurses (Cost of Living)',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'NICU Nurse Salary by State 2026: All 50 States',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'L&D vs ICU Nurse Salary 2026: Which Pays More?',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'ER vs ICU Nurse Salary 2026: Which Pays More?',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'BSN vs ADN Salary Difference 2026: Worth It?',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'How to Read a Travel Nursing Contract: 12 Checks',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'CNA vs LPN vs RN Salary 2026: Full Pay Comparison',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'Nurse Salary Negotiation Playbook 2026: Scripts',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'Charge Nurse Salary vs Staff Nurse 2026',
    date: '2026-04-15',
...
<ul>
  ...
  },
  {
    ...
    metaTitle: 'Florida RN Salary 2026: Hourly Pay & City Breakdown',
    date: '2026-04-20',
  ...
  },
  {
    ...
    metaTitle: 'Miami RN Salary 2026: Hourly Pay by Experience',
    date: '2026-04-21',
  ...
  },
  {
    ...
    metaTitle: 'ICU Nurse Salary 2026: Pay, Requirements & Career',
    date: '2026-04-22',
  ...
  },
  {
    ...
    metaTitle: 'Nurse Salary Negotiation Scripts 2026: Templates',
    date: '2026-04-23',
  ...
  },
  {
    ...
    metaTitle: 'Highest Paying States for RNs 2026: Rankings',
    date: '2026-04-24',
  ...
  {
    slug: 'california-rn-salary-2026',
    href: '/california-rn-salary-2026/',
    title: 'California RN Salary 2026: Regional Breakdown, Hourly Pay & What Nurses Actually Keep',
    metaTitle: 'California RN Salary 2026: Regional Pay Breakdown',
    date: '2026-04-27',
    excerpt: 'California RNs average $132,000/year — but Bay Area, LA, San Diego, and Central Valley all differ by $20,000–$40,000. Full 2026 breakdown with experience tiers, specialty premiums, union impact, and cost-of-living reality check.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'California RN salary 2026',
    secondaryKeywords: ['RN salary California', 'nurse salary California by city', 'California nurse hourly pay', 'California RN average salary'],
    coverImage: '/images/california-rn-salary-2026-hero.webp',
    imageAlt: 'California RN salary 2026 map showing regional pay differences across Bay Area, LA, and San Diego',
    metaDescription: 'California RN salary 2026: $120K–$145K statewide, hourly rates $57–$70/hr. Regional breakdown for Bay Area, LA, San Diego, and Central Valley with experience tiers.',
    content: '',
  },
  {
    slug: 'rn-salary-los-angeles-2026',
    href: '/rn-salary-los-angeles-2026/',
    title: 'Los Angeles RN Salary 2026: Hourly Pay, Hospital Breakdown & What You Keep',
    metaTitle: 'Los Angeles RN Salary 2026: Hospital Pay Breakdown',
    date: '2026-04-28',
    excerpt: 'LA RNs earn $125,000–$140,000 annually in 2026. Cedars-Sinai, UCLA Health, and USC Keck pay $60–$70/hr base. Full breakdown by employer, experience, and specialty — plus shift differentials and sign-on bonus data.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'Los Angeles RN salary 2026',
    secondaryKeywords: ['RN salary LA', 'nurse salary Los Angeles', 'Cedars-Sinai RN pay', 'UCLA nurse salary', 'LA RN hourly rate'],
    coverImage: '/images/rn-salary-los-angeles-2026-hero.webp',
    imageAlt: 'Los Angeles RN salary 2026 showing downtown LA skyline and nurse pay data',
    metaDescription: 'Los Angeles RN salary 2026: $125K–$140K average, $60–$67/hr base. Hospital-by-hospital breakdown with Cedars-Sinai, UCLA, and USC Keck pay data plus sign-on bonuses.',
    content: '',
  },
  {
    slug: 'texas-rn-salary-2026',
    href: '/texas-rn-salary-2026/',
    title: 'Texas RN Salary 2026: Hourly Pay, City Breakdown & the No-Tax Advantage',
    metaTitle: 'Texas RN Salary 2026: City Pay & No-Tax Advantage',
    date: '2026-04-29',
    excerpt: 'Texas RNs earn $80,000–$98,000/year in 2026 with zero state income tax — worth $8,000–$14,000/year in real take-home vs high-tax states. Houston, Dallas, and Austin city breakdown with specialty premiums and sign-on data.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'Texas RN salary 2026',
    secondaryKeywords: ['RN salary Texas', 'nurse salary Texas', 'Houston RN salary', 'Dallas RN salary', 'Austin nurse pay', 'Texas no state tax nurse'],
    coverImage: '/images/texas-rn-salary-2026.png',
    imageAlt: 'Texas RN salary 2026 map highlighting Houston, Dallas, and Austin pay rates',
    metaDescription: 'Texas RN salary 2026: $80K–$98K average, zero state income tax, Houston vs Dallas vs Austin pay breakdown. Experience tiers, specialty premiums, and sign-on bonus data.',
    content: '',
  },
  {
    slug: 'new-york-rn-salary-2026',
    href: '/new-york-rn-salary-2026/',
    title: 'New York RN Salary 2026: NYC Pay, Upstate Rates & What Nurses Actually Keep',
    metaTitle: 'New York RN Salary 2026: NYC & Upstate Pay Rates',
    date: '2026-04-30',
    excerpt: 'NYC RNs earn $108,000–$128,000+ at major academic systems in 2026, but state + city taxes cut take-home significantly. Upstate averages $75,000–$90,000. Full breakdown with NYU Langone, NewYork-Presbyterian, and union pay data.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'New York RN salary 2026',
    secondaryKeywords: ['RN salary New York', 'nurse salary NYC', 'NYC RN hourly rate', 'upstate New York nurse salary', 'NYSNA union pay'],
    coverImage: '/images/new-york-rn-salary-2026.png',
    imageAlt: 'New York City RN salary 2026 with NYC skyline and nurse pay breakdown',
    metaDescription: 'New York RN salary 2026: NYC averages $108K–$123K+, upstate $75K–$90K. Union pay scales, tax impact, hospital-by-hospital data for NYU Langone, NewYork-Presbyterian, and Mount Sinai.',
    content: '',
  },
  {
    slug: 'arizona-rn-salary-2026',
    href: '/arizona-rn-salary-2026/',
    title: 'Arizona RN Salary 2026: Phoenix Metro Pay, Statewide Rates & Career Outlook',
    metaTitle: 'Arizona RN Salary 2026: Phoenix & Statewide Rates',
    date: '2026-05-01',
    excerpt: 'Arizona RNs earn $79,000–$98,000/year in 2026 with a 2.5% flat income tax — one of the lowest in the nation. Phoenix leads the state at $85,000–$98,000. Banner Health, Mayo Clinic, and HonorHealth pay data included.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'Arizona RN salary 2026',
    secondaryKeywords: ['RN salary Arizona', 'nurse salary Phoenix', 'Phoenix RN hourly rate', 'Banner Health nurse pay', 'Arizona nurse salary 2026'],
    coverImage: '/images/arizona-rn-salary-2026.png',
    imageAlt: 'Arizona RN salary 2026 map showing Phoenix, Scottsdale, and Tucson pay rates',
    metaDescription: 'Arizona RN salary 2026: Phoenix averages $85K–$98K, Tucson $79K–$89K. Banner Health, Mayo Clinic, and HonorHealth pay data plus 2.5% flat-tax advantage and sign-on bonuses.',
    content: '',
  },
  {
    slug: 'nicu-nurse-salary-2026',
    href: '/nicu-nurse-salary-2026/',
    title: 'NICU Nurse Salary 2026: Hourly Pay, State Breakdown & How to Earn More',
    metaTitle: 'NICU Nurse Salary 2026: Pay by State & How to Earn',
    date: '2026-05-04',
    excerpt: 'NICU nurses earn $80,000–$115,000/year in 2026 — more in California and Massachusetts, less in the South. RNC-NIC certification adds $3–$6/hr. Full state breakdown, shift differential math, and top hospital data.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'NICU nurse salary 2026',
    secondaryKeywords: ['how much do nicu nurses make', 'nicu rn salary', 'neonatal icu nurse pay', 'nicu nurse hourly rate', 'nicu nurse salary by state'],
    coverImage: '/images/nicu-nurse-salary-2026.png',
    imageAlt: 'NICU nurse salary 2026 with neonatal intensive care unit incubator and pay data',
    metaDescription: 'NICU nurse salary 2026: $80,000–$115,000/year, $38–$55/hr. State-by-state pay breakdown, RNC-NIC certification impact, shift differentials, and top-paying hospitals.',
    content: '',
  },
  {
    slug: 'boston-rn-salary-2026',
    href: '/boston-rn-salary-2026/',
    title: 'Boston RN Salary 2026: Hourly Pay, Hospital Breakdown & What Nurses Actually Keep',
    metaTitle: 'Boston RN Salary 2026: Hospital Pay Breakdown',
    date: '2026-05-05',
    excerpt: 'Boston RNs earn $105,000–$122,000/year in 2026 at major academic systems — one of the highest-paying nurse markets east of California. Full hospital breakdown, MNA union data, shift differentials, and take-home math.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'Boston RN salary 2026',
    secondaryKeywords: ['rn salary boston ma', 'nurse salary boston', 'registered nurse salary boston', 'massachusetts rn salary', 'nursing salary boston 2026'],
    coverImage: '/images/boston-rn-salary-2026.png',
    imageAlt: 'Boston RN salary 2026 with Massachusetts General Hospital and Boston skyline',
    metaDescription: "Boston RN salary 2026: $105,000–$122,000 average, $50–$59/hr base. Mass General, Brigham, BIDMC, and Boston Children's pay data with shift differentials and take-home analysis.",
    content: '',
  },
  {
    slug: 'neonatal-nurse-salary-2026',
    href: '/neonatal-nurse-salary-2026/',
    title: 'Neonatal Nurse Salary 2026: What Newborn Care Nurses Actually Earn',
    metaTitle: 'Neonatal Nurse Salary 2026: What Nurses Earn',
    date: '2026-05-06',
    excerpt: 'Neonatal nurses earn $68,000–$115,000/year in 2026 — but the range is wide because "neonatal nurse" covers everything from mother-baby units to Level IV NICUs. Full unit-level pay breakdown, RNC-NIC impact, and top hospitals.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'neonatal nurse salary 2026',
    secondaryKeywords: ['how much do neonatal nurses make', 'neonatal nurse pay', 'neonatal rn salary', 'neonatal nurse income', 'neonatal nurse hourly rate'],
    coverImage: '/images/neonatal-nurse-salary-2026.png',
    imageAlt: 'Neonatal nurse salary 2026 showing newborn care unit and pay breakdown',
    metaDescription: 'Neonatal nurse salary 2026: $68,000–$115,000/year depending on unit level, state, and certification. NICU vs. mother-baby pay comparison, RNC-NIC impact, and top-paying hospitals.',
    content: '',
  },
  {
    slug: 'phoenix-rn-salary-2026',
    href: '/phoenix-rn-salary-2026/',
    title: 'Phoenix RN Salary 2026: Metro Pay, Top Hospitals & the Arizona Tax Advantage',
    metaTitle: 'Phoenix RN Salary 2026: Metro Pay & Tax Advantage',
    date: '2026-05-07',
    excerpt: 'Phoenix RNs earn $85,000–$98,000/year in 2026 — Arizona\'s 2.5% flat income tax gives nurses one of the best take-home advantages in the Sun Belt. Banner Health, Mayo Clinic, and HonorHealth pay data included.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'Phoenix RN salary 2026',
    secondaryKeywords: ['registered nurse salary phoenix az', 'nurse salary phoenix arizona', 'rn salary phoenix', 'phoenix arizona nursing pay', 'banner health nurse salary'],
    coverImage: '/images/phoenix-rn-salary-2026.png',
    imageAlt: 'Phoenix RN salary 2026 showing downtown Phoenix skyline and nurse pay breakdown',
    metaDescription: 'Phoenix RN salary 2026: $85,000–$98,000/year average, $41–$47/hr. Banner Health, Mayo Clinic, and HonorHealth pay data, 2.5% flat tax advantage, and Scottsdale vs. Tucson comparison.',
    content: '',
  },
  {
    slug: 'orlando-rn-salary-2026',
    href: '/orlando-rn-salary-2026/',
    title: 'Orlando RN Salary 2026: Hourly Pay, Hospital Breakdown & Florida Tax Advantage',
    metaTitle: 'Orlando RN Salary 2026: Pay & Florida Tax Advantage',
    date: '2026-05-08',
    excerpt: 'Orlando RNs earn $78,000–$92,000/year in 2026 — below coastal markets but with zero state income tax, a fast-growing healthcare system, and strong sign-on bonuses that push total first-year compensation higher.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'Orlando RN salary 2026',
    secondaryKeywords: ['nurse salary orlando florida', 'rn salary orlando', 'nursing salary orlando', 'registered nurse salary orlando fl', 'orlando health nurse pay'],
    coverImage: '/images/orlando-rn-salary-2026.png',
    imageAlt: 'Orlando RN salary 2026 with Florida skyline and nurse pay breakdown',
    metaDescription: 'Orlando RN salary 2026: $78,000–$92,000/year average, $38–$44/hr. Orlando Health, AdventHealth, and UCF Health pay data, zero income tax advantage, and sign-on bonus breakdown.',
    content: '',
  },
  ...
  // ── Week-04 posts ────────────────────────────────────────────────────────
  {
    slug: 'dallas-rn-salary-2026',
    href: '/dallas-rn-salary-2026/',
    title: 'Dallas RN Salary 2026: $80,910/yr + UT Southwestern, Baylor & Parkland Pay',
    metaTitle: 'Dallas RN Salary 2026: Top Hospital Pay Guide',
    date: '2026-04-29',
    excerpt: 'Dallas RNs average $80,910/year ($38.90/hr) in 2026 — above the Texas state average, with UT Southwestern and Baylor Scott & White pushing specialty nurses past $110K. Full hospital breakdown, sign-on bonuses, and DFW metro comparison inside.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'dallas rn salary 2026',
    secondaryKeywords: ['nurse salary dallas tx', 'rn salary dallas', 'dallas texas nurse pay', 'ut southwestern nurse salary', 'baylor scott white rn pay'],
    coverImage: '/images/dallas-rn-salary-2026-hero.png',
    imageAlt: 'Dallas RN salary 2026 geometric hero graphic highlighting DFW nurse compensation data',
    metaDescription: 'Dallas RN salary 2026: $80,910 avg, $38.90/hr. Compare pay at UT Southwestern, Baylor Scott & White, Parkland, plus Fort Worth, sign-ons & negotiation tips.',
    content: '',
  },
  {
    slug: 'cna-salary-2026',
    href: '/cna-salary-2026/',
    title: 'CNA Salary 2026: How Much Do CNAs Make Per Hour & Year?',
    metaTitle: 'CNA Salary 2026: Hourly & Annual Pay Guide',
    date: '2026-05-01',
    excerpt: 'CNAs earn $38,200/year ($18.37/hr) nationally in 2026. See pay by state, work setting, and the full career ladder from CNA to LPN to RN to NP.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'cna salary 2026',
    secondaryKeywords: ['how much do cnas make', 'cna hourly pay', 'cna salary by state', 'certified nursing assistant salary', 'cna pay 2026'],
    coverImage: '/images/cna-salary-2026-hero.png',
    imageAlt: 'Certified nursing assistant helping a patient in a hospital room',
    metaDescription: 'CNAs earn $38,200/yr ($18.37/hr) on average in 2026. See CNA pay by state, setting, and experience — plus how much more LPNs and RNs make.',
    content: '',
  },
  {
    slug: 'lpn-salary-2026',
    href: '/lpn-salary-2026/',
    title: 'LPN Salary 2026: How Much Do LPNs Make Per Hour & Year?',
    metaTitle: 'LPN Salary 2026: Hourly & Annual Pay Guide',
    date: '2026-05-01',
    excerpt: 'LPNs earn $55,000/year ($26.44/hr) nationally in 2026 — $16,800/year more than CNAs and $23,000–$31,000 less than RNs. See pay by state, setting, and the LPN-to-RN bridge ROI.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'lpn salary 2026',
    secondaryKeywords: ['how much do lpns make', 'lvn salary 2026', 'lpn hourly pay', 'licensed practical nurse salary', 'lpn vs rn salary'],
    coverImage: '/images/lpn-salary-2026-hero.png',
    imageAlt: 'Licensed practical nurse reviewing patient chart in clinic setting',
    metaDescription: 'LPNs earn $55,000/yr ($26.44/hr) on average in 2026. See LPN pay by state, setting, and how it compares to CNA and RN — plus the fastest path to higher pay.',
    content: '',
  },
  {
    slug: 'nurse-practitioner-salary-2026',
    href: '/nurse-practitioner-salary-2026/',
    title: 'Nurse Practitioner Salary 2026: $126K Avg + Pay by Specialty & State',
    metaTitle: 'Nurse Practitioner Salary 2026: $126K by Specialty',
    date: '2026-05-01',
    excerpt: 'NPs earn $126,000/year ($60.58/hr) nationally in 2026 — $37,000 more than staff RNs. PMHNPs and ACNPs top the specialty rankings. See pay by state and all 8 NP specialties.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'nurse practitioner salary 2026',
    secondaryKeywords: ['np salary 2026', 'nurse practitioner pay', 'fnp salary', 'pmhnp salary', 'how much do nurse practitioners make'],
    coverImage: '/images/nurse-practitioner-salary-2026-hero.png',
    imageAlt: 'Nurse practitioner consulting with a patient in an outpatient clinic',
    metaDescription: 'NPs earn $126,000/yr ($60.58/hr) on average in 2026. See NP salary by specialty (FNP, PMHNP, ACNP), state rankings, and how NP pay compares to RN and physician.',
    content: '',
  },
  {
    slug: 'pmhnp-salary-2026',
    href: '/pmhnp-salary-2026/',
    title: 'PMHNP Salary 2026: How Much Do Psychiatric NPs Make?',
    metaTitle: 'PMHNP Salary 2026: Psychiatric NP Pay by State',
    date: '2026-05-01',
    excerpt: 'PMHNPs earn $138,000/year ($66.35/hr) in 2026 — the fastest-growing NP specialty. Telehealth PMHNPs in private practice can reach $180,000–$220,000/year.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'pmhnp salary 2026',
    secondaryKeywords: ['psychiatric nurse practitioner salary', 'psychiatric mental health np salary', 'pmhnp pay by state', 'mental health np salary 2026'],
    coverImage: '/images/pmhnp-salary-2026-hero.png',
    imageAlt: 'Psychiatric nurse practitioner in a telehealth consultation',
    metaDescription: 'PMHNPs earn $138,000/yr ($66.35/hr) on average in 2026 — the fastest-growing NP specialty. See pay by state, setting, and how PMHNP compares to FNP and CRNA.',
    content: '',
  },
  {
    slug: 'fnp-salary-2026',
    href: '/fnp-salary-2026/',
    title: 'FNP Salary 2026: How Much Do Family Nurse Practitioners Make?',
    metaTitle: 'FNP Salary 2026: Family Nurse Practitioner Pay',
    date: '2026-05-01',
    excerpt: 'FNPs earn $122,000/year ($58.65/hr) in 2026. Most common NP specialty — see pay by state, urgent care vs. private practice, and how FNP compares to PMHNP and ACNP.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'fnp salary 2026',
    secondaryKeywords: ['family nurse practitioner salary', 'fnp pay by state', 'family np salary 2026', 'how much do fnps make'],
    coverImage: '/images/fnp-salary-2026-hero.png',
    imageAlt: 'Family nurse practitioner seeing a patient in a primary care clinic',
    metaDescription: 'FNPs earn $122,000/yr ($58.65/hr) on average in 2026. See family nurse practitioner salary by state, setting, and how FNP compares to PMHNP, ACNP, and CRNA.',
    content: '',
  },
  {
    slug: 'agnp-salary-2026',
    href: '/agnp-salary-2026/',
    title: 'AGNP Salary 2026: Adult-Gerontology NP Pay by State & Track',
    metaTitle: 'AGNP Salary 2026: Adult-Gerontology NP Pay by State',
    date: '2026-05-01',
    excerpt: 'AGNPs earn $126,000/year in 2026. Acute care track (AGNP-AC) earns $138,000–$148,000/year in hospital settings. See primary vs. acute care salary split by state.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'agnp salary 2026',
    secondaryKeywords: ['adult gerontology nurse practitioner salary', 'agnp-ac salary', 'agnp-pc salary', 'adult gerontology np pay'],
    coverImage: '/images/agnp-salary-2026-hero.png',
    imageAlt: 'Adult-gerontology nurse practitioner consulting with an older adult patient',
    metaDescription: 'AGNPs earn $126,000/yr ($60.58/hr) on average in 2026. See adult-gerontology NP salary by state, primary vs. acute care track, and how AGNP compares to FNP and PMHNP.',
    content: '',
  },
  {
    slug: 'denver-rn-salary-2026',
    href: '/denver-rn-salary-2026/',
    title: 'Denver RN Salary 2026: How Much Do Nurses Make in Denver, CO?',
    metaTitle: 'Denver RN Salary 2026: What Nurses Earn in CO',
    date: '2026-05-01',
    excerpt: 'Denver RNs earn $84,500/year ($40.63/hr) in 2026. UCHealth and Children\'s Colorado pay the market top. Colorado\'s 4.4% income tax reduces take-home vs. no-tax states.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'denver rn salary 2026',
    secondaryKeywords: ['nurse salary denver co', 'rn salary denver colorado', 'uchealth nurse pay', 'denver nurse pay 2026'],
    coverImage: '/images/denver-rn-salary-2026-hero.png',
    imageAlt: 'Denver nurse outside UCHealth University of Colorado Hospital',
    metaDescription: 'Denver RNs earn $84,500/yr ($40.63/hr) on average in 2026. See pay at UCHealth, SCL Health, Children\'s Colorado, and Denver Health — plus cost-of-living analysis.',
    content: '',
  },
  {
    slug: 'nashville-rn-salary-2026',
    href: '/nashville-rn-salary-2026/',
    title: 'Nashville RN Salary 2026: How Much Do Nurses Make in Nashville, TN?',
    metaTitle: 'Nashville RN Salary 2026: What Nurses Earn in TN',
    date: '2026-05-01',
    excerpt: 'Nashville RNs earn $72,800/year in 2026. No state income tax and Vanderbilt\'s $80K–$105K pay range make Nashville more competitive than the nominal salary suggests.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'nashville rn salary 2026',
    secondaryKeywords: ['nurse salary nashville tn', 'rn salary nashville tennessee', 'vanderbilt nurse salary', 'nashville nurse pay 2026'],
    coverImage: '/images/nashville-rn-salary-2026-hero.png',
    imageAlt: 'Nashville nurse outside Vanderbilt University Medical Center',
    metaDescription: 'Nashville RNs earn $72,800/yr ($35.00/hr) on average in 2026. See pay at Vanderbilt, HCA, and Saint Thomas — plus why Nashville is a top travel nurse market.',
    content: '',
  },
  {
    slug: 'minneapolis-rn-salary-2026',
    href: '/minneapolis-rn-salary-2026/',
    title: 'Minneapolis RN Salary 2026: How Much Do Nurses Make in Minneapolis?',
    metaTitle: 'Minneapolis RN Salary 2026: What Nurses Earn',
    date: '2026-05-01',
    excerpt: 'Minneapolis RNs earn $85,000/year in 2026. Strong MNA union contracts at Allina, M Health Fairview, and HealthPartners set competitive wages — offset by Minnesota\'s high income tax.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'minneapolis rn salary 2026',
    secondaryKeywords: ['nurse salary minneapolis mn', 'rn salary minnesota', 'allina nurse pay', 'mna union nurses salary 2026'],
    coverImage: '/images/minneapolis-rn-salary-2026-hero.png',
    imageAlt: 'Minneapolis nurse outside M Health Fairview hospital',
    metaDescription: 'Minneapolis RNs earn $85,000/yr ($40.87/hr) on average in 2026. See pay at Mayo Clinic, M Health Fairview, and Allina — plus Minnesota\'s strong union contracts explained.',
    content: '',
  },
  {
    slug: 'las-vegas-rn-salary-2026',
    href: '/las-vegas-rn-salary-2026/',
    title: 'Las Vegas RN Salary 2026: How Much Do Nurses Make in Las Vegas?',
    metaTitle: 'Las Vegas RN Salary 2026: What Nurses Earn in NV',
    date: '2026-05-01',
    excerpt: 'Las Vegas RNs earn $85,500/year in 2026. Nevada\'s zero income tax adds $4,000–$7,000/year in real take-home. UMC Level 1 Trauma pays $88K–$114K for experienced nurses.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'las vegas rn salary 2026',
    secondaryKeywords: ['nurse salary las vegas nv', 'rn salary nevada', 'umc las vegas nurse pay', 'las vegas nurse salary 2026'],
    coverImage: '/images/las-vegas-rn-salary-2026-hero.png',
    imageAlt: 'Las Vegas nurse outside University Medical Center Nevada',
    metaDescription: 'Las Vegas RNs earn $85,500/yr ($41.11/hr) on average in 2026. See pay at UMC, Sunrise, and Valley hospitals — plus Nevada\'s no-income-tax advantage explained.',
    content: '',
  },
  {
    slug: 'austin-rn-salary-2026',
    href: '/austin-rn-salary-2026/',
    title: 'Austin RN Salary 2026: $86,320/yr + Top Hospital Pay & Negotiation Tips',
    metaTitle: 'Austin RN Salary 2026: Top Hospital Pay & Tips',
    date: '2026-04-30',
    excerpt: 'Austin RNs earn $86,320/year ($41.50/hr) in 2026 — above the Texas average but offset by the highest COL of any Texas metro. See pay at Dell Seton, St. David\'s, and Ascension Seton, plus no-state-income-tax take-home math.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'austin rn salary 2026',
    secondaryKeywords: ['nurse salary austin tx', 'rn salary austin', 'dell seton nurse pay', 'st davids nurse salary', 'austin texas nurse pay 2026'],
    coverImage: '/images/austin-rn-salary-2026-hero.png',
    imageAlt: 'Austin registered nurse outside Dell Seton Medical Center illustrating 2026 RN salary guide',
    metaDescription: 'Austin RN salary 2026: $86,320 avg, $41.50/hr. Compare pay at St. David\'s, Ascension Dell Seton, and UT Health Austin — plus cost-of-living reality check.',
    content: '',
  },
  {
    ...
    metaTitle: 'Houston RN Salary 2026: Avg Pay & Top Hospitals',
    date: '2026-04-29',
    excerpt: 'Houston RNs earn $82,140/year ($39.49/hr) on average in 2026 — the Texas Medical Center cluster pushes senior ICU and ER nurses past $108K. See pay by hospital, cost-of-living-adjusted comparison vs Dallas & Austin, and sign-on bonus data.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'houston rn salary 2026',
    secondaryKeywords: ['nurse salary houston tx', 'rn salary houston', 'houston methodist nurse pay', 'md anderson nurse salary', 'texas medical center rn pay'],
    coverImage: '/images/houston-rn-salary-2026-hero.png',
    imageAlt: 'Houston registered nurse walking toward Texas Medical Center skyline illustrating 2026 RN salary guide',
    metaDescription: 'Houston RN salary 2026: $82,140/yr average, $39.49/hr. See pay by hospital, sign-on bonuses, cost-of-living-adjusted ranking vs Dallas & Austin.',
    content: '',
  },
  {
    slug: 'pediatric-nurse-salary-2026',
    href: '/pediatric-nurse-salary-2026/',
    title: 'Pediatric Nurse Salary 2026: $78K–$112K Pay by State, Hospital & Specialty',
    metaTitle: 'Pediatric Nurse Salary 2026: $78K–$112K by State',
    date: '2026-04-29',
    excerpt: 'Pediatric nurses earn $78,000–$112,000 in 2026 depending on unit, certification, and state. PICU and pediatric trauma pay the most; ambulatory the least. Full subspecialty breakdown, top children\'s hospitals, and CPN/CPEN certification premiums inside.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'pediatric nurse salary 2026',
    secondaryKeywords: ['pediatric rn salary', 'picu nurse salary', 'childrens hospital nurse pay', 'pediatric nursing salary by state', 'cpn certification salary'],
    coverImage: '/images/pediatric-nurse-salary-2026-hero.png',
    imageAlt: 'Pediatric nurse with young patient in children\'s hospital illustrating 2026 salary guide',
    metaDescription: 'Pediatric nurse salary 2026: $78K–$112K depending on state, certification, and unit. See PICU vs floor, sign-on bonuses, top children\'s hospitals & growth path.',
    content: '',
  },
  {
    slug: 'per-diem-nurse-salary-2026',
    href: '/per-diem-nurse-salary-2026/',
    title: 'Per Diem Nurse Salary 2026: $55–$95/hr Rates + No-Benefits Math Decoded',
    metaTitle: 'Per Diem Nurse Salary 2026: $55–$95/hr Rate Guide',
    date: '2026-04-29',
    excerpt: 'Per diem nurses earn $55–$95/hr in 2026, but the real take-home math is more complex once you factor in self-funded benefits, unpredictable scheduling, and taxes. Full breakdown of rates by state, direct vs agency pay, and the true cost of no benefits.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'per diem nurse salary 2026',
    secondaryKeywords: ['per diem rn pay', 'per diem nurse hourly rate', 'per diem vs staff nurse salary', 'float pool nurse pay', 'per diem nurse benefits cost'],
    coverImage: '/images/per-diem-nurse-salary-2026-hero.png',
    imageAlt: 'Per diem nurse reviewing clipboard schedule illustrating 2026 hourly pay guide',
    metaDescription: 'Per diem nurse salary 2026: $55–$95/hr depending on state and specialty. See real take-home math after factoring in no benefits, taxes, scheduling — full breakdown.',
    content: '',
  },
  {
    slug: 'rn-vs-lpn-salary-2026',
    href: '/rn-vs-lpn-salary-2026/',
    title: 'RN vs LPN Salary 2026: RNs Earn $30K+ More — Full Pay & ROI Breakdown',
    metaTitle: 'RN vs LPN Salary 2026: $30K+ Pay Gap Explained',
    date: '2026-04-29',
    excerpt: 'RNs earn $89,010/year vs LPNs at $59,730 — a $29,280 gap that widens over a career. But does the extra 2–3 years of education pay off? Full ROI math, state-by-state gap analysis, and when an LPN license actually makes sense.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'rn vs lpn salary 2026',
    secondaryKeywords: ['rn lpn pay difference', 'lpn vs rn hourly rate', 'is rn worth it over lpn', 'rn lpn salary comparison by state', 'lpn to rn bridge salary increase'],
    coverImage: '/images/rn-vs-lpn-salary-2026-hero.png',
    imageAlt: 'RN vs LPN salary comparison 2026 showing pay gap and career ROI breakdown',
    metaDescription: 'RN vs LPN salary 2026: RNs earn $89,010/yr, LPNs $59,730 — a $29,280 gap. Compare hourly pay, education ROI, hours, and 5-year earnings with full math.',
    content: '',
  },
  // Week 05 — new salary guide pages
  {
    slug: 'chicago-rn-salary-2026',
    href: '/chicago-rn-salary-2026/',
    title: 'Chicago RN Salary 2026: $83,580/yr Average + Hospital-by-Hospital Breakdown',
    metaTitle: 'Chicago RN Salary 2026: Hospital-by-Hospital Pay',
    date: '2026-04-29',
    excerpt: 'Chicago registered nurses earn $83,580/year on average in 2026. See pay at Northwestern, Rush, UChicago Medicine, Advocate, and Northshore, plus cost-of-living math and Midwest comparisons.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'chicago rn salary 2026',
    secondaryKeywords: ['chicago nurse salary', 'rn pay chicago hospitals', 'northwestern nurse salary', 'chicago icu nurse pay', 'illinois rn salary 2026'],
    coverImage: '/images/chicago-rn-salary-2026-hero.png',
    imageAlt: 'Chicago RN salary 2026 showing average pay at major hospitals including Northwestern and Rush',
    metaDescription: 'Chicago RN salary 2026: $83,580/yr average. See pay at Northwestern, Rush, UChicago Medicine, and Advocate plus Midwest cost-of-living comparison.',
    content: '',
  },
  {
    ...
    metaTitle: 'Seattle RN Salary 2026: No-Tax Take-Home Math',
    date: '2026-04-29',
    excerpt: 'Seattle registered nurses earn $102,740/year on average in 2026 with no state income tax. See pay at UW Medicine, Swedish, Virginia Mason Franciscan, and Providence, plus Pacific Northwest comparisons.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'seattle rn salary 2026',
    secondaryKeywords: ['seattle nurse salary', 'washington state rn pay', 'uw medicine nurse salary', 'seattle icu nurse pay', 'washington rn salary 2026'],
    coverImage: '/images/seattle-rn-salary-2026-hero.png',
    imageAlt: 'Seattle RN salary 2026 showing $102,740 average pay with no-state-tax take-home math',
    metaDescription: 'Seattle RN salary 2026: $102,740/yr average, no state income tax. Pay at UW Medicine, Swedish, Virginia Mason, and Providence plus West Coast comparisons.',
    content: '',
  },
  {
    ...
    metaTitle: 'Atlanta RN Salary 2026: Emory, Grady & Piedmont Pay',
    date: '2026-04-29',
    excerpt: "Atlanta registered nurses earn $71,280/year on average in 2026. See pay at Emory, Grady Memorial, Piedmont, Wellstar, and Children's Healthcare of Atlanta, plus Southeast comparisons.",
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'atlanta rn salary 2026',
    secondaryKeywords: ['atlanta nurse salary', 'georgia rn pay', 'emory nurse salary', 'grady memorial nurse pay', 'atlanta icu nurse salary'],
    coverImage: '/images/atlanta-rn-salary-2026-hero.png',
    imageAlt: 'Atlanta RN salary 2026 showing $71,280 average pay at Emory, Grady, and Piedmont hospitals',
    metaDescription: 'Atlanta RN salary 2026: $71,280/yr average. Pay at Emory, Grady Memorial, Piedmont, and Wellstar plus Southeast cost-of-living comparison.',
    content: '',
  },
  {
    slug: 'crna-salary-2026',
    href: '/crna-salary-2026/',
    title: 'CRNA Salary 2026: $214,000 Average + State Rankings and ROI vs RN',
    metaTitle: 'CRNA Salary 2026: $214K Avg + State Rankings',
    date: '2026-04-29',
    excerpt: 'CRNAs earn $214,000/year on average in 2026 making nurse anesthesia the highest-paid nursing credential. See salary by state, practice setting, and the full 10-year ROI versus staying an RN.',
    category: 'Salary Data',
    readTime: '11 min read',
    focusKeyword: 'crna salary 2026',
    secondaryKeywords: ['nurse anesthetist salary', 'crna pay by state', 'crna vs rn salary', 'crna salary california', 'how much does a crna make'],
    coverImage: '/images/crna-salary-2026-hero.png',
    imageAlt: 'CRNA salary 2026 showing $214,000 national average with state rankings and ROI versus RN',
    metaDescription: 'CRNA salary 2026: $214,000/yr national average. See pay by state, practice setting, and the full ROI calculation vs staying an RN.',
    content: '',
  },
  {
    slug: 'new-grad-rn-salary-2026',
    href: '/new-grad-rn-salary-2026/',
    title: 'New Grad RN Salary 2026: $62K-$88K First-Year Pay by State + Sign-On Bonuses',
    metaTitle: 'New Grad RN Salary 2026: $62K–$88K by State',
    date: '2026-04-29',
    excerpt: 'New graduate RN salary in 2026 ranges from $62,000-$88,000 depending on state and employer. See first-year pay by state, sign-on bonuses, residency stipends, and the fastest path to $100K.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'new grad rn salary 2026',
    secondaryKeywords: ['new graduate nurse salary', 'first year rn pay', 'nurse residency salary', 'new nurse sign on bonus', 'new grad rn hourly rate'],
    coverImage: '/images/new-grad-rn-salary-2026-graduation.png',
    imageAlt: 'New graduate RN salary 2026 showing $62K-$88K first-year pay range by state',
    metaDescription: 'New grad RN salary 2026: $62,000-$88,000 first-year pay. State-by-state breakdown, sign-on bonuses, residency stipends, and fastest path to $100K.',
    content: '',
  },
  {
    slug: 'houston-vs-dallas-rn-salary-2026',
    href: '/houston-vs-dallas-rn-salary-2026/',
    title: 'Houston vs Dallas RN Salary 2026: Which Texas City Pays Nurses More?',
    metaTitle: 'Houston vs Dallas RN Salary 2026: Which Pays More?',
    date: '2026-04-29',
    excerpt: 'Houston RNs average $82,140/year vs Dallas at $80,910. Factor in cost of living, hospital quality, and sign-on bonuses, and the choice between Texas biggest nursing markets comes down to more than the headline number.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'houston vs dallas rn salary 2026',
    secondaryKeywords: ['houston nurse salary', 'dallas nurse salary', 'texas rn pay comparison', 'best city for nurses in texas', 'houston vs dallas nursing jobs'],
    coverImage: '/images/houston-vs-dallas-rn-salary-2026-hero.png',
    imageAlt: 'Houston vs Dallas RN salary comparison 2026 showing city-by-city pay, hospitals, and cost of living',
    metaDescription: 'Houston RNs earn $82,140/yr vs Dallas $80,910. Full comparison: hospitals, specialties, cost of living, sign-on bonuses, and which Texas city wins for nurses.',
    content: '',
  },
  {
    slug: 'icu-vs-er-nurse-salary-2026',
    href: '/icu-vs-er-nurse-salary-2026/',
    title: 'ICU vs ER Nurse Salary 2026: Which Specialty Pays More?',
    metaTitle: 'ICU vs ER Nurse Salary 2026: Which Pays More?',
    date: '2026-04-29',
    excerpt: 'ICU nurses average $95,200/year vs ER nurses at $92,800. The $2,400 gap grows with experience and certifications. Full comparison: hourly rates, sign-on bonuses, career trajectory, and which specialty sets you up better long-term.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'icu vs er nurse salary 2026',
    secondaryKeywords: ['icu nurse pay vs er nurse pay', 'critical care nurse salary', 'emergency nurse salary', 'ccrn vs cen pay premium', 'icu or er better pay'],
    coverImage: '/images/icu-vs-er-nurse-salary-2026-hero.png',
    imageAlt: 'ICU vs ER nurse salary 2026 comparison showing average pay, hourly rates, and specialty career paths',
    metaDescription: 'ICU nurses earn $95,200/yr vs ER nurses at $92,800 in 2026. Full salary comparison: hourly rates, certifications, sign-on bonuses, and long-term earnings.',
    content: '',
  },
  {
    slug: 'nurse-sign-on-bonus-guide-2026',
    href: '/nurse-sign-on-bonus-guide-2026/',
    title: 'Nurse Sign-On Bonus Guide 2026: How Much, Who Pays, and How to Negotiate',
    metaTitle: 'Nurse Sign-On Bonus 2026: How to Negotiate',
    date: '2026-04-29',
    excerpt: 'Nurse sign-on bonuses average $5,000-$20,000 in 2026. ICU and ER nurses command $15,000-$30,000 at major systems. Amounts by specialty and state, clawback rules, tax implications, and negotiation tactics.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'nurse sign on bonus 2026',
    secondaryKeywords: ['nursing sign on bonus average', 'icu nurse sign on bonus', 'hospital sign on bonus nurses', 'nursing bonus clawback rules', 'how to negotiate nurse sign on bonus'],
    coverImage: '/images/nurse-sign-on-bonus-guide-2026-hero.png',
    imageAlt: 'Nurse reviewing job offer sign-on bonus amount with hospital recruiter in 2026',
    metaDescription: 'Nurse sign-on bonuses 2026: $5K-$30K depending on specialty. See amounts by specialty and state, clawback rules, tax implications, and how to negotiate.',
    content: '',
  },
  {
    ...
    category: 'Travel Nursing',
    readTime: '10 min read',
    focusKeyword: 'travel nurse vs staff nurse salary 2026',
    secondaryKeywords: ['travel nursing vs staff pay', 'is travel nursing worth it financially', 'travel nurse take home pay', 'travel nurse housing stipend', 'travel vs permanent nurse salary'],
    coverImage: '/images/travel-nurse-vs-staff-nurse-salary-2026-hero.png',
    imageAlt: 'Travel nurse with luggage versus staff nurse at home facility representing the 2026 salary comparison',
    metaDescription: 'Travel nurses earn $95K-$130K vs staff nurses at $77,600 in 2026. Real after-tax math, housing costs, benefit gaps, and when staff nursing pays more.',
    content: '',
  },
  {
    slug: 'rn-salary-by-years-of-experience-2026',
    href: '/rn-salary-by-years-of-experience-2026/',
    title: 'RN Salary by Years of Experience 2026: Full Career Pay Trajectory',
    metaTitle: 'RN Salary by Experience 2026: Career Pay Guide',
    date: '2026-04-29',
    excerpt: 'RN salary grows from $62K-$88K as a new grad to $108K-$140K+ at 15 years without advanced credentials. Full 2026 pay trajectory by specialty, state, and the three fastest inflection points for salary growth.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'rn salary by years of experience 2026',
    secondaryKeywords: ['nurse salary by experience', 'rn pay growth over time', 'how much more does an experienced nurse make', 'nurse salary 5 years experience', 'rn salary plateau'],
    coverImage: '/images/rn-salary-by-years-of-experience-2026-hero.png',
    imageAlt: 'RN salary trajectory from new grad to 15+ years showing career pay growth milestones in 2026',
    metaDescription: 'RN salary by experience 2026: $62K-$88K new grad to $108K-$140K+ at 15 years. Year-by-year growth by specialty, state, and certification milestones.',
    content: '',
  },
  // ── Week-07 — May 2026 ───────────────────────────────────────────────────
  {
    slug: 'new-york-city-rn-salary-2026',
    href: '/new-york-city-rn-salary-2026/',
    title: 'NYC RN Salary 2026: $109,860/yr Avg + NYSNA Union Pay Breakdown',
    metaTitle: 'NYC RN Salary 2026: $109,860 + NYSNA Union Pay',
    date: '2026-05-07',
    excerpt: 'New York City RN salary 2026: $109,860/yr avg. Pay at NYU Langone, NY-Presbyterian, Mount Sinai, MSK — plus NYSNA union step scales and take-home after NYC taxes.',
    category: 'Salary Data',
    readTime: '11 min read',
    focusKeyword: 'nyc rn salary 2026',
    secondaryKeywords: ['nurse salary new york city 2026', 'nysna union pay scale', 'nyc hospital rn pay', 'nursing salary nyc'],
    coverImage: '/images/new-york-city-rn-salary-2026-hero.png',
    imageAlt: 'Registered nurse in navy scrubs standing outside a New York City hospital with the Manhattan skyline in the background',
    metaDescription: 'New York City RN salary 2026: $109,860/yr avg ($52.82/hr). Pay at NYU Langone, NY-Presbyterian, Mount Sinai, MSK — plus NYSNA union step scales and real take-home after NYC taxes.',
    content: '',
  },
  {
    slug: 'philadelphia-rn-salary-2026',
    href: '/philadelphia-rn-salary-2026/',
    title: 'Philadelphia RN Salary 2026: $84,200/yr Avg + Penn Medicine vs CHOP Pay',
    metaTitle: 'Philadelphia RN Salary 2026: Penn vs CHOP Pay',
    date: '2026-05-07',
    excerpt: 'Philadelphia RN salary 2026: $84,200/yr avg ($40.48/hr). Pay at Penn Medicine, CHOP, Jefferson, and Temple — plus city wage tax take-home math.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'philadelphia rn salary 2026',
    secondaryKeywords: ['nurse salary philadelphia', 'penn medicine rn pay', 'chop nurse salary', 'pasnap union nurses', 'philadelphia city wage tax nurse'],
    coverImage: '/images/philadelphia-rn-salary-2026-hero.png',
    imageAlt: 'Registered nurse in navy scrubs standing outside a Philadelphia hospital entrance with city skyline visible in the background',
    metaDescription: 'Philadelphia RN salary 2026: $84,200/yr avg ($40.48/hr). See pay at Penn Medicine, CHOP, Jefferson, and Temple — plus city wage tax take-home math and travel nurse rates.',
    content: '',
  },
  {
    slug: 'san-diego-rn-salary-2026',
    href: '/san-diego-rn-salary-2026/',
    title: 'San Diego RN Salary 2026: $104,800/yr Avg + UC San Diego vs Scripps Pay',
    metaTitle: 'San Diego RN Salary 2026: UCSD vs Scripps Pay',
    date: '2026-05-07',
    excerpt: 'San Diego RN salary 2026: $104,800/yr avg ($50.38/hr). Pay at UCSD Health, Scripps, Sharp, and Kaiser — plus California state tax take-home analysis.',
    category: 'Salary Data',
    readTime: '10 min read',
    focusKeyword: 'san diego rn salary 2026',
    secondaryKeywords: ['nurse salary san diego', 'ucsd health rn pay', 'scripps nurse salary', 'cna union san diego', 'california nurse salary'],
    coverImage: '/images/san-diego-rn-salary-2026-hero.png',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern San Diego hospital entrance with palm trees and blue sky',
    metaDescription: 'San Diego RN salary 2026: $104,800/yr avg ($50.38/hr). Pay at UCSD Health, Scripps, Sharp, and Kaiser — plus California state tax take-home analysis and travel nurse rates.',
    content: '',
  },
  {
    slug: 'critical-care-nurse-salary-2026',
    href: '/critical-care-nurse-salary-2026/',
    title: 'Critical Care Nurse Salary 2026: $98,400/yr Avg + ICU Pay by State & Cert',
    metaTitle: 'Critical Care Nurse Salary 2026: ICU Pay Guide',
    date: '2026-05-07',
    excerpt: 'Critical care (ICU) nurse salary 2026: $98,400/yr national avg. Pay by state, hospital system, ICU unit type, and CCRN certification differential.',
    category: 'Specialty Salaries',
    readTime: '11 min read',
    focusKeyword: 'critical care nurse salary 2026',
    secondaryKeywords: ['icu nurse salary 2026', 'ccrn certification pay', 'critical care rn pay by state', 'icu travel nurse rates', 'critical care nurse salary by hospital'],
    coverImage: '/images/critical-care-nurse-salary-2026-hero.png',
    imageAlt: 'Critical care nurse in scrubs monitoring patient vital signs in a modern hospital ICU',
    metaDescription: 'Critical care nurse salary 2026: $98,400/yr avg nationally. ICU RN pay by state, hospital system, and CCRN certification — plus how to earn $130K+ in the ICU.',
    content: '',
  },
  {
    slug: 'or-nurse-salary-2026',
    href: '/or-nurse-salary-2026/',
    title: 'OR Nurse Salary 2026: $102,800/yr Avg + Perioperative Pay by State & Role',
    metaTitle: 'OR Nurse Salary 2026: Perioperative Pay Guide',
    date: '2026-05-07',
    excerpt: 'OR nurse (perioperative RN) salary 2026: $102,800/yr national avg. Pay by state, hospital, role type, and CNOR certification differential.',
    category: 'Specialty Salaries',
    readTime: '10 min read',
    focusKeyword: 'or nurse salary 2026',
    secondaryKeywords: ['operating room nurse salary 2026', 'perioperative nurse pay', 'cnor certification differential', 'or travel nurse rates', 'surgical nurse salary by state'],
    coverImage: '/images/or-nurse-salary-2026-hero.png',
    imageAlt: 'Operating room nurse in surgical scrubs and cap preparing a sterile instrument tray in a modern hospital operating room',
    metaDescription: 'OR nurse (perioperative RN) salary 2026: $102,800/yr national avg. Pay by state, hospital, scrub vs. circulator role, CNOR certification differential, and travel rates.',
    content: '',
  },
  {
    slug: 'labor-delivery-nurse-salary-2026',
    href: '/labor-delivery-nurse-salary-2026/',
    title: 'Labor & Delivery Nurse Salary 2026: $96,800/yr Avg + L&D Pay by State',
    metaTitle: 'Labor & Delivery Nurse Salary 2026: L&D Pay',
    date: '2026-05-07',
    excerpt: 'Labor and delivery nurse salary 2026: $96,800/yr national avg. L&D RN pay by state, hospital, high-risk vs. routine, and RNC-OB cert differential.',
    category: 'Specialty Salaries',
    readTime: '10 min read',
    focusKeyword: 'labor and delivery nurse salary 2026',
    secondaryKeywords: ['ld nurse salary 2026', 'labor delivery rn pay', 'rnc-ob certification pay', 'l&d travel nurse rates', 'high risk ob nurse salary'],
    coverImage: '/images/labor-delivery-nurse-salary-2026-hero.png',
    imageAlt: 'Labor and delivery nurse in light blue scrubs standing in a bright, modern hospital birth center',
    metaDescription: 'Labor and delivery nurse salary 2026: $96,800/yr national avg. L&D RN pay by state, hospital, inpatient obstetrics vs. high-risk, RNC-OB cert differential, and travel rates.',
    content: '',
  },
  {
    slug: 'travel-nurse-agency-comparison-2026',
    href: '/travel-nurse-agency-comparison-2026/',
    title: 'Best Travel Nurse Agencies 2026: Pay Comparison + Which Agency Pays Most',
    metaTitle: 'Best Travel Nurse Agencies 2026: Who Pays Most?',
    date: '2026-05-07',
    excerpt: 'Best travel nurse agencies 2026 ranked by pay, transparency, and contract terms. Compare AMN, Aya, FlexCare, Atlas, Nomad, and more — plus how to negotiate your package.',
    category: 'Travel Nursing',
    readTime: '12 min read',
    focusKeyword: 'best travel nurse agencies 2026',
    secondaryKeywords: ['travel nurse agency comparison', 'which travel agency pays most', 'aya vs amn travel nursing', 'flexcare atlas nomad health', 'travel nurse pay package negotiation'],
    coverImage: '/images/travel-nurse-agency-comparison-2026-hero.png',
    imageAlt: 'Travel nurse with a rolling suitcase arriving at a hospital entrance in a new city, wearing scrubs and badge',
    metaDescription: 'Best travel nurse agencies 2026 ranked by pay, transparency, and contract terms. Compare AMN, Aya, FlexCare, Atlas, Nomad, and 8 more — plus how to negotiate your package.',
    content: '',
  },
  // ── Week-12 ────────────────────────────────────────────────────────────────
  {
    slug: 'nurse-salary-cost-of-living-2026',
    href: '/nurse-salary-cost-of-living-2026/',
    title: 'Nurse Salary Cost of Living 2026: Where $89K Goes Furthest',
    metaTitle: 'Nurse Salary & Cost of Living 2026: Real Value',
    date: '2026-05-22',
    excerpt: 'A $89K nurse salary buys very different lives in different cities. Real purchasing power ranked for 15 metros — adjusted for COL and state income tax.',
    category: 'Salary Data',
    readTime: '9 min read',
    focusKeyword: 'nurse salary cost of living 2026',
    secondaryKeywords: ['rn purchasing power by city', 'nurse salary after taxes', 'best cities for nurses cost of living', 'nursing salary real value', 'nurse salary adjustment cost of living'],
    coverImage: '/images/nurse-salary-cost-of-living-2026-hero.webp',
    imageAlt: 'Registered nurse in navy scrubs reviewing a salary offer letter at a desk with a city skyline visible through the window',
    metaDescription: 'Nurse salary buys different lives in different cities. Real purchasing power for RNs in 15 metros — what stays in your pocket after taxes and housing.',
    content: '',
  },
  // ── Week-15 ────────────────────────────────────────────────────────────────
  {
    slug: 'raleigh-rn-salary-2026',
    href: '/raleigh-rn-salary-2026/',
    title: 'Raleigh RN Salary 2026: What Research Triangle Nurses Actually Earn',
    metaTitle: 'Raleigh RN Salary 2026: Research Triangle Pay',
    date: '2026-06-01',
    excerpt: 'Raleigh-area RNs earn around $78,000–$84,000/year in 2026 — 8–12% above the NC state average. Duke Raleigh Hospital leads at $80,000–$94,000, followed by UNC Rex and WakeMed. Full breakdown by hospital, specialty, and experience.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'raleigh rn salary 2026',
    secondaryKeywords: ['rn salary raleigh nc', 'nurse salary raleigh', 'wakemed rn salary', 'unc rex nurse salary', 'duke raleigh hospital nurse pay', 'research triangle nurse salary', 'north carolina rn salary by city'],
    coverImage: '/images/raleigh-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in navy scrubs standing outside a modern Research Triangle hospital in Raleigh North Carolina with warm natural light',
    metaDescription: 'Raleigh RNs earn around $78,000–$84,000/yr in 2026. WakeMed, Duke Raleigh, and UNC Rex pay data, specialty rates, and Research Triangle negotiation tips.',
    content: '',
  },
  {
    slug: 'charge-nurse-salary-2026',
    href: '/charge-nurse-salary-2026/',
    title: 'Charge Nurse Salary vs Staff RN: What the Differential Actually Pays in 2026',
    metaTitle: 'Charge Nurse Salary vs Staff RN 2026',
    date: '2026-05-28',
    excerpt: 'The charge nurse differential averages $3/hr nationally — adding $5,600/year on a 36-hour schedule. ICU charge nurses earn $9,500–$10,000 more than staff RN peers. Here is the full breakdown by unit, facility, and state.',
    category: 'Specialty Salaries',
    readTime: '8 min read',
    focusKeyword: 'charge nurse salary vs rn',
    secondaryKeywords: ['charge nurse pay differential', 'charge nurse salary 2026', 'do charge nurses get paid more', 'charge nurse vs staff rn salary', 'icu charge nurse salary', 'charge nurse differential by hospital'],
    coverImage: '/images/charge-nurse-salary-2026-hero.webp',
    imageAlt: 'Experienced charge nurse in scrubs standing at a nurses station reviewing patient assignments on a clipboard in a busy hospital unit',
    metaDescription: 'Charge nurses earn $4,500–$10,000 more per year than staff RNs. The differential averages $3/hr but ranges from $1.50 to $6/hr by unit and facility. Full breakdown.',
    content: '',
  },
  {
    slug: 'washington-dc-rn-salary-2026',
    href: '/washington-dc-rn-salary-2026/',
    title: 'Washington DC RN Salary 2026: How Much Do Nurses Make in the DC Metro?',
    metaTitle: 'Washington DC RN Salary 2026',
    date: '2026-05-28',
    excerpt: 'RNs in the Washington DC metro earn around $99,000–$103,000/year — top 5 nationally. MedStar, Inova, and Georgetown lead the market. Tax strategy matters: Virginia-side nurses take home $3,000–$5,000 more on the same salary.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'washington dc rn salary 2026',
    secondaryKeywords: ['nurse salary washington dc', 'rn salary dc metro', 'inova nurse salary', 'dc nurse pay', 'northern virginia rn salary', 'medstar nurse salary'],
    coverImage: '/images/washington-dc-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in navy blue scrubs standing outside a major hospital in Washington DC with the Capitol building softly visible in the background',
    metaDescription: 'DC metro RNs earn $99,000–$103,000/year in 2026 — top 5 nationally. MedStar and Inova lead the market. Tax strategy adds $3K–$5K more for Virginia-side nurses.',
    content: '',
  },
  {
    slug: 'north-carolina-rn-salary-2026',
    href: '/north-carolina-rn-salary-2026/',
    title: 'North Carolina RN Salary 2026: What Nurses Earn Across the State',
    metaTitle: 'North Carolina RN Salary 2026',
    date: '2026-05-28',
    excerpt: 'North Carolina RNs earn $72,970/year on average per BLS OEWS May 2024. Durham and Charlotte nurses average $80,000–$90,000. Duke and UNC Health lead state pay. NC is a compact state — your license works in 40+ states.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'north carolina rn salary 2026',
    secondaryKeywords: ['nc nurse salary', 'registered nurse salary north carolina', 'charlotte rn salary', 'duke nurse salary', 'unc health nurse salary', 'raleigh nurse salary'],
    coverImage: '/images/north-carolina-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in scrubs standing confidently outside a large North Carolina hospital with trees and blue sky in the background',
    metaDescription: 'NC RNs earn $72,970/yr per BLS OEWS May 2024. Charlotte and Durham nurses average $80K–$90K. Duke and UNC Health lead state pay. Compact license works in 40+ states.',
    content: '',
  },
  {
    slug: 'dialysis-nurse-salary-2026',
    href: '/dialysis-nurse-salary-2026/',
    title: 'Dialysis Nurse Salary 2026: Outpatient vs. Hospital Pay, by State and Employer',
    metaTitle: 'Dialysis Nurse Salary 2026',
    date: '2026-05-28',
    excerpt: 'Dialysis nurses earn $72,000–$88,000/year in 2026 — but the setting makes a $15,000 difference. Hospital-based acute dialysis pays $84,000–$95,000. DaVita and Fresenius outpatient centers pay $70,000–$80,000. CNN certification adds $3,000–$8,000.',
    category: 'Specialty Salaries',
    readTime: '8 min read',
    focusKeyword: 'dialysis nurse salary 2026',
    secondaryKeywords: ['nephrology nurse salary', 'davita nurse salary', 'fresenius nurse salary', 'dialysis rn pay', 'cnn certification salary', 'dialysis nurse pay by state'],
    coverImage: '/images/dialysis-nurse-salary-2026-hero.webp',
    imageAlt: 'Dialysis nurse in scrubs monitoring a patient during hemodialysis treatment in a bright outpatient dialysis center with modern equipment',
    metaDescription: 'Dialysis nurses earn $72,000–$88,000/year. Hospital-based acute dialysis pays $15,000 more than DaVita or Fresenius outpatient. CNN certification adds $3K–$8K.',
    content: '',
  },
  {
    slug: 'virginia-rn-salary-2026',
    href: '/virginia-rn-salary-2026/',
    title: 'Virginia RN Salary 2026: What Nurses Earn From Northern VA to Hampton Roads',
    metaTitle: 'Virginia RN Salary 2026',
    date: '2026-05-28',
    excerpt: 'Virginia RNs earn $77,720/year per BLS OEWS May 2024 — but Northern VA nurses at Inova average $96,000–$108,000. The state is two distinct markets. Virginia compact license works in 40+ states. Tax advantage over DC adds $3K–$5K take-home.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'virginia rn salary 2026',
    secondaryKeywords: ['virginia nurse salary', 'inova nurse salary', 'northern virginia rn salary', 'richmond nurse salary', 'vcu health nurse salary', 'virginia beach rn salary'],
    coverImage: '/images/virginia-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in scrubs standing outside a modern Virginia hospital with autumn trees and a clear blue sky in the background',
    metaDescription: 'Virginia RNs average $77,720/yr per BLS. Northern VA Inova nurses average $96K–$108K. Compact license state — works in 40+ states. Tax advantage over DC adds $3K–$5K.',
    content: '',
  },
  {
    slug: 'miami-rn-salary-2026',
    href: '/miami-rn-salary-2026/',
    title: "Miami RN Salary 2026: What South Florida Nurses Actually Earn",
    metaTitle: "Miami RN Salary 2026: Jackson Health & Baptist Pay",
    date: '2026-06-01',
    excerpt: "Miami-area RNs earn around $90,000–$97,000/year in 2026 — Florida's highest-paying metro. Jackson Health, Baptist Health South Florida, and UM/Sylvester breakdown with specialty rates and negotiation tips.",
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'miami rn salary 2026',
    secondaryKeywords: ['nurse salary miami fl', 'jackson health rn salary', 'baptist health nurse salary miami', 'um sylvester nurse pay', 'miami icu nurse salary', 'south florida nurse salary'],
    coverImage: '/images/miami-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in navy blue scrubs standing outside a modern Miami hospital entrance with the South Florida skyline softly blurred in the background',
    metaDescription: "Miami RNs earn around $90,000–$97,000/yr — Florida's top metro. Jackson Health, Baptist & UM/Sylvester pay data plus ICU, ER, and L&D specialty rates.",
    content: '',
  },
  {
    slug: 'jacksonville-rn-salary-2026',
    href: '/jacksonville-rn-salary-2026/',
    title: 'Jacksonville RN Salary 2026: Mayo Clinic FL, UF Health & Baptist Pay',
    metaTitle: 'Jacksonville RN Salary 2026: Mayo & UF Health Pay',
    date: '2026-06-01',
    excerpt: 'Jacksonville RNs earn around $82,000–$89,000/year in 2026. Mayo Clinic Florida leads with $88,000–$105,000. UF Health Level I trauma center and Baptist Health pay breakdown plus specialty rates and negotiation tips.',
    category: 'Salary Data',
    readTime: '7 min read',
    focusKeyword: 'jacksonville rn salary 2026',
    secondaryKeywords: ['nurse salary jacksonville fl', 'mayo clinic florida rn salary', 'uf health jacksonville nurse pay', 'baptist health jacksonville nurse salary', 'jacksonville icu nurse salary', 'northeast florida nurse salary'],
    coverImage: '/images/jacksonville-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in navy blue scrubs standing outside a modern Jacksonville Florida hospital entrance with the St. Johns River bridge softly blurred in the background',
    metaDescription: 'Jacksonville RNs earn around $82,000–$89,000/yr. Mayo Clinic Florida, UF Health & Baptist Health pay data plus specialty rates and negotiation tips.',
    content: '',
  },
  {
    slug: 'ucsf-rn-salary-2026',
    href: '/ucsf-rn-salary-2026/',
    title: 'UCSF RN Salary 2026: CNA Contract, Step Scale & Differentials',
    metaTitle: 'UCSF RN Salary 2026: CNA Contract & Step Scale',
    date: '2026-06-01',
    excerpt: 'UCSF Health RNs earn $155,000–$170,000/year under the CNA union contract — among the highest hospital nurse salaries in the US. Full step scale, shift differentials ($8.50–$11/hr nights), UC pension, and how UCSF compares to Kaiser and Stanford.',
    category: 'Salary Data',
    readTime: '8 min read',
    focusKeyword: 'ucsf rn salary 2026',
    secondaryKeywords: ['ucsf nurse salary', 'ucsf health rn pay', 'cna union contract ucsf', 'ucsf nurse step scale', 'san francisco hospital nurse salary', 'ucsf vs kaiser nurse pay'],
    coverImage: '/images/ucsf-rn-salary-2026-hero.webp',
    imageAlt: 'Registered nurse in navy blue scrubs standing outside the UCSF Medical Center in San Francisco with the Parnassus Heights campus visible in the background',
    metaDescription: 'UCSF Health RNs earn $155,000–$170,000/yr — among the highest in the US. CNA union contract, shift differentials ($8.50–$11/hr nights), and UCSF vs. Kaiser comparison.',
    content: '',
  },
  {
    slug: 'msn-nurse-salary-2026',
    href: '/msn-nurse-salary-2026/',
    title: 'MSN Nurse Salary 2026: FNP, PMHNP, CNM & CNS Pay Guide',
    metaTitle: 'MSN Nurse Salary 2026: FNP, PMHNP & CNM Pay',
    date: '2026-06-01',
    excerpt: 'MSN nurses earn $98,000–$141,000/year in 2026 depending on specialty. PMHNP leads at $121,000–$141,000. Full salary breakdown by role, state, and ROI analysis versus BSN pay.',
    category: 'Specialty Salaries',
    readTime: '8 min read',
    focusKeyword: 'msn nurse salary 2026',
    secondaryKeywords: ['msn nursing salary', 'fnp salary 2026', 'pmhnp salary', 'msn vs bsn salary', 'nurse practitioner salary msn', 'advanced practice nurse salary 2026'],
    coverImage: '/images/msn-nurse-salary-2026-hero.webp',
    imageAlt: 'Advanced practice nurse in professional attire reviewing patient chart in a modern clinical office representing the MSN-level nursing career path',
    metaDescription: 'MSN nurses earn $108,000–$131,000/yr in 2026 depending on specialty. FNP, PMHNP, AGNP, CNM, and CNS salary breakdown plus ROI on the MSN degree vs. BSN.',
    content: '',
  },
];
