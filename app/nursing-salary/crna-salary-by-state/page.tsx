...
export const metadata: Metadata = {
  ...
  description: 'CRNAs earn $214,200/yr nationally in 2026. California tops out at $258K. See all 50 states ranked, how CRNA pay compares to anesthesiologists, and strategies…',
};
