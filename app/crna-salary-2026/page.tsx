...
export const metadata: Metadata = {
  title: 'CRNA Salary 2026: $214,000/yr Est. + Top States & Settings',
...
const faqs = [
  ...
  { question: 'How competitive is CRNA school admission?', answer: 'Very competitive. Most programs require: BSN, active RN license, 1–3 years of ICU experience (critical care preferred), GPA 3.0+, GRE scores, and shadowing/clinical hours. ICU specialty (CCRN certification) is the single strongest application differentiator.' },
