    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <h3 className="text-lg font-bold text-blue-600 mb-2">Nurse Salary Calculator →</h3>
            <p className="text-gray-700">Use our free nurse salary calculator to see what RNs earn in your state and specialty</p>
          </Link>
          <Link
            href="/"
            className="border-2 border-blue-200 rounded-lg p-6 hover:border-blue-400 hover:shadow-md transition-all"
          ...
          >
            <h3 className="text-lg font-bold text-purple-600 mb-2">RN Salary by State →</h3>
            <p className="text-gray-700">See average RN pay across all 50 states with cost-of-living context</p>
          </Link>
        </div>
      </div>
    </main>
