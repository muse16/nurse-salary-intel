...
export const metadata: Metadata = {
  ...
  description: 'Psychiatric nurses earn $78,000–$95,000/yr based on the latest BLS data. See psych RN pay by state, setting, and experience — plus how inpatient vs…',
