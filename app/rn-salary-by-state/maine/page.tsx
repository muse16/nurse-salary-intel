...
export const metadata: Metadata = {
  ...
  description: 'Maine RNs average $78,920/yr ($37.94/hr). See pay by city, MaineHealth vs. Northern Light rates, rural shortage bonuses, and why demand is surging in the…',
};
