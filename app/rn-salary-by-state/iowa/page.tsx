...
export const metadata: Metadata = {
  ...
  description:
    'Iowa RNs average $66,220/yr ($31.84/hr). See pay by city, specialty, and experience level — plus sign-on bonuses and how to negotiate your next contract.',
};

const faqs = [
  {
    question: 'How much do nurses make in Iowa?',
    answer: 'The average RN salary in Iowa is $66,220/year ($31.84/hr). Rates vary by city, specialty, and experience level.',
  },
  {
...
export default function IowaRNSalary() {
  return (
    ...
    >
      <p>
        Iowa registered nurses earn an average of $66,220/year ($31.84/hr).
