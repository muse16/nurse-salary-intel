...
export const metadata: Metadata = {
  title: 'RN Salary Washington (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Washington is $97,960/year ($47.10/hr) in 2026. Compare pay by city and specialty.',
};
