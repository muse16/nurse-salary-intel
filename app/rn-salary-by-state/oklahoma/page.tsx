...
export const metadata: Metadata = {
  title: 'RN Salary Oklahoma (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Oklahoma is $67,150/year ($32.28/hr) in 2026. Compare pay by city and specialty.',
};
