...
export const metadata: Metadata = {
  ...
  description:
    'Michigan RNs average $79,830/yr ($38.38/hr). See pay by city, specialty, and experience level — plus sign-on bonuses and how to negotiate your next contract.',
};

const faqs = [
  {
    question: 'How much do nurses make in Michigan?',
    answer: 'The average RN salary in Michigan is $79,830/year ($38.38/hr). Rates vary by city, specialty, and experience level.',
  },
  {
...
export default function MichiganRNSalary() {
  return (
    ...
    >
      <p>
        Michigan registered nurses earn an average of $79,830/year ($38.38/hr).
