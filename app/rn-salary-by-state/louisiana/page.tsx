...
export const metadata: Metadata = {
  ...
  description:
    'Louisiana RNs average $69,980/yr ($33.65/hr). See pay by city, specialty, and experience level — plus sign-on bonuses and how to negotiate your next contract.',
};

const faqs = [
  {
    question: 'How much do nurses make in Louisiana?',
    answer: 'The average RN salary in Louisiana is $69,980/year ($33.65/hr). Rates vary by city, specialty, and experience level.',
  },
  {
...
export default function LouisianaRNSalary() {
  return (
    ...
    >
      <p>
        Louisiana registered nurses earn an average of $69,980/year ($33.65/hr).
