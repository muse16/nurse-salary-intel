...
export const metadata: Metadata = {
  title: 'RN Salary Kentucky (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Kentucky is $69,480/year ($33.40/hr) in 2026. Compare pay by city and specialty.',
};
