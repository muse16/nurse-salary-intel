...
export const metadata: Metadata = {
  ...
  description:
    'Delaware RNs average $81,450/yr ($39.16/hr) in 2026. See pay by city, specialty, and experience level — plus sign-on bonuses and how to negotiate your next contract.',
};
