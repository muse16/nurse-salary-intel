...
export const metadata: Metadata = {
  ...
  description:
    'Utah RNs average $74,860/yr ($36.00/hr). See pay by city, specialty, and experience level — plus sign-on bonuses and how to negotiate your next contract.',
};

const faqs = [
  {
    question: 'How much do nurses make in Utah?',
    answer: 'The average RN salary in Utah is $74,860/year ($36.00/hr). Rates vary by city, specialty, and experience level.',
  },
  {
...
export default function UtahRNSalary() {
  return (
    ...
    >
      <p>
        Utah registered nurses earn an average of $74,860/year ($36.00/hr).
