...
export const metadata: Metadata = {
  title: 'RN Salary Arkansas (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Arkansas is $67,010/year ($32.22/hr) in 2026. Compare pay by city and specialty.',
};
