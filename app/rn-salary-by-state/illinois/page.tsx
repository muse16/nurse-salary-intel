...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Nursing demand in Illinois continues to grow, driven by an aging population and ongoing healthcare staffing shortages.',
  },
];

const cityData = [
  { label: 'Chicago', avgSalary: '$87,000–$97,000', hourlyRate: '$41.83–$46.63/hr' },
  { label: 'Rockford', avgSalary: '$79,000–$88,000', hourlyRate: '$37.98–$42.31/hr' },
  { label: 'Peoria', avgSalary: '$78,000–$87,000', hourlyRate: '$37.50–$41.83/hr' },
  { label: 'State Average', avgSalary: '$82,020', hourlyRate: '$39.43/hr' },
];

export default function IllinoisRNSalary() {
  return (
    <SEOPageLayout
      breadcrumbs={[
        { label: 'Home', href: '/' },
    ...
    >
      ...
      <SalaryTable
        title="RN Salary by City in Illinois (2026)"
      ...
      <a
        href="https://www.vivian.com/search?query=Travel+RN+Illinois&utm_source=nursesalaryintel&utm_medium=referral"
        target="_blank"
      ...
      >
        Find Travel RN Jobs in Illinois \u2192
      </a>

      <h2 className="text-2xl font-bold font-headline text-on-surface">Compare Illinois to Other States</h2>
