...
export const metadata: Metadata = {
  title: 'RN Salary Alaska (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Alaska is $96,990/year ($46.63/hr) in 2026. Compare pay by city and specialty.',
};
