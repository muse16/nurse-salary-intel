...
export const metadata: Metadata = {
  ...
  description:
    'Virginia RNs average $77,720/yr ($37.37/hr). See pay by city, specialty, and experience level — plus sign-on bonuses and how to negotiate your next contract.',
};

const faqs = [
  {
    question: 'How much do nurses make in Virginia?',
    answer: 'The average RN salary in Virginia is $77,720/year ($37.37/hr). Rates vary by city, specialty, and experience level.',
  },
  {
...
export default function VirginiaRNSalary() {
  return (
    ...
    >
      <p>
        Virginia registered nurses earn an average of $77,720/year ($37.37/hr).
