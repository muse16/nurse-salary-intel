...
export const metadata: Metadata = {
  title: 'RN Salary Wisconsin (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Wisconsin is $78,140/year ($37.57/hr) in 2026. Compare pay by city and specialty.',
};
