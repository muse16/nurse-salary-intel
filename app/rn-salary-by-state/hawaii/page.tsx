...
export const metadata: Metadata = {
  title: 'RN Salary Hawaii (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Hawaii is $113,060/year ($54.36/hr) in 2026. Compare pay by city and specialty.',
};
