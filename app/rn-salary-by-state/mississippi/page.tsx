...
export const metadata: Metadata = {
  title: 'RN Salary Mississippi (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Mississippi is $64,320/year ($30.92/hr) in 2026. Compare pay by city and specialty.',
};
