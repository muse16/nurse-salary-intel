...
export const metadata: Metadata = {
  title: 'RN Salary Oregon (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Oregon is $98,630/year ($47.42/hr) in 2026. Compare pay by city and specialty.',
};
