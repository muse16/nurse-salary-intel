...
export const metadata: Metadata = {
  ...
  description: 'North Dakota RNs average $72,140/yr ($34.68/hr) with no state income tax. See pay by city, Sanford Health rates, rural shortage area bonuses, and loan…',
};
