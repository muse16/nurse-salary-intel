...
export const metadata: Metadata = {
  title: 'RN Salary Alabama (2026): Hourly Pay + Highest Paying Cities',
  description:
    'Average RN salary in Alabama is $66,390/year ($31.92/hr) in 2026. Compare pay by city and specialty.',
};
