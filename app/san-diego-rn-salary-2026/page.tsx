...
export const metadata: Metadata = {
  ...
  description: 'San Diego RN salary 2026: $104,800/yr avg ($50.38/hr). Pay at UCSD Health, Scripps, Sharp, and Kaiser — plus California state license premium and travel nurse…',
};
