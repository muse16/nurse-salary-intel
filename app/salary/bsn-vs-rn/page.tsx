...
export const metadata: Metadata = {
  ...
  description: 'BSN nurses earn $10,400 more per year than ADN RNs based on the latest BLS data. See state-by-state pay gap, lifetime ROI, and which hospitals require a BSN…',
