...
export const metadata: Metadata = {
  ...
  description: 'New grad RN salary 2026: $62,000–$88,000/year by state. First-year pay, sign-on bonuses, residency stipends, and how to reach $100K faster.',
