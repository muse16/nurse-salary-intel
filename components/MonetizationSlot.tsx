  ...
  return (
    <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="space-y-3 mb-4">
          <a
            href={`https://www.indeed.com/jobs?q=travel+nurse+rn${city ? `&l=${encodeURIComponent(`${city}, ${state}`)}` : ''}`}
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="bg-white rounded-lg border-2 border-green-300 p-4">
          ...
          <a
            href={`https://www.indeed.com/jobs?q=registered+nurse${city ? `&l=${encodeURIComponent(`${city}, ${state}`)}` : ''}`}
            target="_blank"
            rel="noopener noreferrer"
